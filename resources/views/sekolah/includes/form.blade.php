<div class="row">
    <div class="col-md-12">
                ...
                <div class="mb-4">
                    ...
                    @error('nama_sekolah')<small class="invalid-feedback">{{ $message }}</small>@enderror
                </div>
                <div class="mb-4">
                    ...
                    @error('alamat_sekolah')<small class="invalid-feedback">{{ $message }}</small>@enderror
                </div>
                <div class="mb-4">
                    ...
                    <input 
                        ...
                        class="form-control {{ $errors->has('telepon_sekolah') ? 'is-invalid' : '' }}" 
                        id="telepon_sekolah" 
                        value="{{ old('telepon_sekolah', $sekolah?->telepon_sekolah) }}" 
                        placeholder="Masukkan Telepon Sekolah" />
                    @error('telepon_sekolah')<small class="invalid-feedback">{{ $message }}</small>@enderror
                </div>
                <div class="mb-4">
                    ...
                    <input 
                        type="text" 
                        name="email_sekolah" 
                        class="form-control {{ $errors->has('email_sekolah') ? 'is-invalid' : '' }}" 
                        id="email_sekolah" 
                        value="{{ old('email_sekolah', $sekolah?->email_sekolah) }}" 
                        placeholder="Masukkan Email Sekolah" />
                    @error('email_sekolah')<small class="invalid-feedback">{{ $message }}</small>@enderror
                </div>
                <div class="mb-4">
                    ...
                    <input 
                        type="file" 
                        name="logo_sekolah" 
                        class="form-control {{ $errors->has('logo_sekolah') ? 'is-invalid' : '' }}" 
                        id="logo_sekolah" 
                        value="{{ old('logo_sekolah', $sekolah?->logo_sekolah) }}" 
                        placeholder="Masukkan Logo Sekolah" />
                    @error('logo_sekolah')<small class="invalid-feedback">{{ $message }}</small>@enderror
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input 
                        ...
                        id="keterangan" 
                        value="{{ old('keterangan', $sekolah?->keterangan) }}" 
